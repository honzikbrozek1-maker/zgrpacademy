...
-- 1. Add distractor columns
ALTER TABLE public.questions
  ADD COLUMN IF NOT EXISTS wrong_option_1 text,
  ADD COLUMN IF NOT EXISTS wrong_option_2 text,
  ADD COLUMN IF NOT EXISTS wrong_option_3 text;

-- 2. RPC: get_level_test - returns shuffled quiz-style options for ALL question types
...
-- 3. RPC: complete_level_v2 - text-based answer scoring across all types
...
BEGIN
  ...
  -- Build map: question_id -> answer_text
